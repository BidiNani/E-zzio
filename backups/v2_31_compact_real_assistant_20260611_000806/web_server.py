...
app = FastAPI(
    title="E-ZZIO",
    version="v2.24-local-dashboard-ui",
    description="E-ZZIO local CPU/RAM-only assistant. Free Cloud Brain Broker, PC Commander, safe action queue, human chat truth guard, memory, human loop, clean core, maintenance, no ads.",
)
...
async def root():
    return {
        ...
        "features": {
            ...
            "cloud_brain": "/cloud-brain/status",
            "ui": "/ui",
            "hybrid_chat": "/api/chat/hybrid",
