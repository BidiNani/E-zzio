...
app = FastAPI(
    title="E-ZZIO",
    version="v2.15.1-pc-optimizer-rescue",
    description="E-ZZIO local CPU/RAM-only assistant. PC optimized. No ads, no tracking, no sponsors.",
)
...
async def root():
    try:
        ...
        payload["version"] = "v2.15.1-pc-optimizer-rescue"
        payload["pc_optimizer"] = "/performance/status"
        return payload
    except Exception:
        return {
            "ok": True,
            ...
            "pc_optimizer": "/performance/status",
            "policy": {
                "cpu_ram_only": True,
                "gpu": "untouched",
                "ads": "forbidden",
...
async def status():
    return {
        ...
        "features": {
            ...
            "warmup": "/performance/warmup",
            "bench": "/performance/bench/quick",
