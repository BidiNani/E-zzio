...
DEFAULT_POLICY = {
    "version": "v2.16.3b-safe-output-sanitizer",
    "models": {
...
def load_policy() -> Dict[str, Any]:
    if POLICY_PATH.exists():
        try:
            ...
            policy["version"] = "v2.16.2-router-precision-fast-truth"
            return policy
        except Exception:
            pass
...
def chat_with_route(text: str, task: str = "auto", speed: str = "auto", predict: int = 260) -> Dict[str, Any]:
    ...
    try:
        ...
        reply = sanitize_truth(response.get("message", {}).get("content", ""), resolved_task)
