...
if (-not (Get-Command git -ErrorAction SilentlyContinue)) {
    throw "git introuvable. Installe Git for Windows ou relance après installation."
}
...
# Torch CPU explicite pour ne pas tirer une stack CUDA.
& $Py -m pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cpu

# Requirements ComfyUI. Si torch est déjà CPU, pip le garde généralement.
