...
app = FastAPI(
    title="E-ZZIO",
    version="v2.16.1-safe-pc-model-router",
    description="E-ZZIO local CPU/RAM-only assistant. PC model router. No ads, no tracking, no sponsors.",
)
