# ============================================================================
# E-ZZIO — VALIDATION FORENSIC STATIQUE v1.1.3
# ============================================================================
...
& {
    ...
    #
    # IMPORTANT :
    #   Ne PAS utiliser $script:Results.
    #
    #   $Results appartient au scope du bloc & { }.
    #   Une fonction PowerShell peut résoudre cette variable dans son
    #   scope parent/dynamique.
    # =========================================================================
    ...
    Write-Host ' E-ZZIO — VALIDATION FORENSIC STATIQUE v1.1.3' -ForegroundColor Cyan
    Write-Host '============================================================' -ForegroundColor Cyan
    Write-Host ''
    ...
    Add-Result `
        ...
        -Status 'PASS' `
        -Count 0 `
        -Details 'Le validateur ne lance jamais la cible.'
    ...
    Write-Host ''
    Write-Host '============================================================' -ForegroundColor Cyan
    Write-Host ' RÉSULTAT FORENSIC STATIQUE v1.1.3' -ForegroundColor Cyan
    Write-Host '============================================================' -ForegroundColor Cyan
    Write-Host ''
