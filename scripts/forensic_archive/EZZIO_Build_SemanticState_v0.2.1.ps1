...
<#
.SYNOPSIS
    E-ZZIO — SEMANTIC TRUTH ENGINE v0.2.1 (NIVEAU 3)
.DESCRIPTION
    ...
    - Navigation absolue corrigée pour l'artefact topologique.
...
# Résolution absolue du parent Topologique
...
if (-not [System.IO.File]::Exists($topologyStatePath)) {
    # Fallback robuste depuis OutputDir
