...
print("[*] Réécriture propre et définitive de supervisor.py...")

sup_path = "runtime/external/supervisor.py"

clean_supervisor_code = '''import time
...
with open(sup_path, "w", encoding="utf-8") as f:
    f.write(clean_supervisor_code)

print("[+] supervisor.py réécrit avec une structure et une indentation parfaites.")
