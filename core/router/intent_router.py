...
class IntentRouter:
    """Classifieur d'intention déterministe basé sur des heuristiques et patterns stricts."""
    ...
    MEMORY_TRIGGERS = [
        r"\b(qu'avons-nous fait|rappel|historique|mémoire|précédemment|hier|audit)\b"
    ]
