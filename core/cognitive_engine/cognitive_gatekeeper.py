    ...
    def evaluate(self, file_path: Path, content_snippet: str = "") -> dict:
        ...
        if rpg_score >= 5 or ("rpg" in path_lower and rpg_score >= 3):
            return {
                ...
                "reason": f"rpg_domain_score_{rpg_score}",
            }
        ...
        if "security" in path_lower or "auth" in path_lower:
            return {
                ...
                "confidence": 0.90,
                "importance": 7,
                "reason": "access_security_trace",
            }
        if "forensic" in path_lower or "ledger" in path_lower:
            return {
                "promoted": True,
                "indexable": True,
                "memory_type": "forensic_event",
                "confidence": 0.95,
                "importance": 8,
                "reason": "forensic_ledger_trace",
            }
        ...
        if "human_chat" in path_lower or "decision" in path_lower:
            return {
                ...
                "confidence": 0.90,
                "importance": 8,
                "reason": "human_interaction_ledger",
            }
        ...
        return {
            ...
            "reason": "insufficient_semantic_confidence_unknown",
        }
