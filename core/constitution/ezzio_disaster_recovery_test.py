...
class DisasterRecoveryTester:
    def __init__(
        self,
        backup_root: Path = Path(r"C:\AI_Backups\E-zzio"),
        test_restore_target: Path = Path(r"C:\AI_Test_Restore\E-ZZIO_RECOVERY_TEST"),
    ):
    ...
    def run_round_trip_test(self) -> Dict[str, Any]:
        ...
        manifest_data.get("global_sha256")
        ...
        print(r"[*] Étape 3 : Restauration isolée dans l'environnement de test (C:\AI_Test_Restore)...")
