...
class CapabilityQualification(BaseModel):
    ...
    source: Optional[str] = Field(None, description="Provenance (interne, github:owner/repo, url)")
    version: Optional[str] = Field(None, description="Version de la capacité")
    license: Optional[str] = Field(None, description="Licence SPDX (ex: MIT, Apache-2.0)")
