...
class FusionEngine:
    ...
    def get_current_situation(self) -> Dict[str, Any]:
        ...
        """
        situation = {"fusion_timestamp": datetime.now(timezone.utc).isoformat(), "highest_attention": "LOW", "modalities": {}}
        ...
        for source, percept in latest_percepts.items():
            situation["modalities"][source] = {"timestamp": percept.timestamp, "data": percept.data}
