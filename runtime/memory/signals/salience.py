...
class MemorySignal:
    ...
    def retention_score(self) -> float:
        ...
        return self.novelty * 0.25 + self.importance * 0.30 + self.future_value * 0.30 + self.confidence * 0.15
...
class SalienceEngine:
    ...
    def evaluate(event_type: str, payload: dict) -> MemorySignal:
        ...
        return MemorySignal(
            novelty=novelty, importance=importance, emotional_weight=emotional_weight, future_value=future_value, confidence=confidence
        )
