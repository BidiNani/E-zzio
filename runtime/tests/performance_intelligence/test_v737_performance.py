...
from core.performance_intelligence.resource_monitor import resource_monitor
...
def run_performance_certification():
    ...
    print(f" [1/3] Profiling runtime (Temps: {prof_light['metrics']['execution_time']}s, RAM: {prof_light['metrics']['memory_mb']} MB) : OK")
    ...
    print(f" [3/3] Calcul optimisation (Score Léger: {score_light['optimization_score']}, Score Lourd: {score_res['optimization_score']}) : OK")
