...
def run_recovery_continuity_drill():
    ...
    last_tx_before.get("sequence") + 1  # Devrait être 61
    ...
    print(
        f"  -> Nouvelle transaction enregistrée : Séquence = {new_tx.get('sequence')} | Previous Hash = {new_tx.get('previous_hash')[:16]}..."
    )
