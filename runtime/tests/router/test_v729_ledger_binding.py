...
def run_binding_tests():
    ...
    try:
        ...
        success = engine.commit_transaction(
            intent="nominal_test", request_id="req-nom-1", candidates=[], selected="qwen3:8b", state="COMPLETED"
        )
        ...
        success_after_const = engine.commit_transaction(
            intent="compromised_const", request_id="req-comp-1", candidates=[], selected="qwen3:8b", state="COMPLETED"
        )
        ...
        success_after_persona = engine.commit_transaction(
            intent="compromised_persona", request_id="req-comp-2", candidates=[], selected="qwen3:8b", state="COMPLETED"
        )
        ...
        success_restored = engine_restored.commit_transaction(
            intent="restored_write", request_id="req-rest-1", candidates=[], selected="qwen3:8b", state="COMPLETED"
        )
