...
async def run_chaos_suite():
    ...
    print(f"  -> Résultat sous Pression RAM Extrême : Plan = [{d_pressure.execution_plane.upper()}] | Provider = [{d_pressure.provider}] | Modèle = [{d_pressure.model}] | Score = {d_pressure.confidence_score}")
    ...
    if ledger_path.exists():
        ...
        if lines:
            ...
            print(f"  -> Dernière entrée journalisée :")
