...
def init_hardened_ledger():
    if not REJECTED_LOG.exists():
        append_rejected_evolution("EVOL-OCR-001", "OCR_ENGINE", "ROI_INSUFFICIENT", {"pdf_image_only_monthly_occurrences": ">20"})
...
def run_audit():
    ...
    print(" Ledger Format             : APPEND-ONLY (.jsonl)")
    print(" Cryptographic Chain       : SECURED (SHA-256 Hashed)")
