...
def run_certification():
    ...
    fail = ledger.log_failure(
        workflow_id="WF-DOC-002", capability="DOCUMENT_ANALYST", failure_type="PDF_ENCRYPTED", resolution="ASK_USER_PASSWORD"
    )
    ...
    print(" Pattern Storage Test   : [PASS] -> Pattern mémorisé.")
