...
def test_v52_active_memory_actuator():
    ...
    try:
        ...
        print(f"[CRITICAL SPIKE] Tier : {res2['tier']} | OOM Index : {res2['oom_index']} | Batch Size : {engine.max_batch_size} | Delay : {engine.max_batch_delay}s", flush=True)
        ...
        assert res3['tier'] == "NOMINAL", f"FAIL: Le système aurait dû repasser en NOMINAL !"
