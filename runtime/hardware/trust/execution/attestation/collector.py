import psutil
from runtime.hardware.trust.execution.attestation.models import ObservationSnapshot, AttestationVerdict
        ...
        try:
            ...
            if not p.is_running():
                return ObservationSnapshot(
                    pid=pid, actual_affinity_mask=[], active_threads=0,
                    peak_ram_mb=0.0, os_enforcement_verified=False, is_alive=False
                )
