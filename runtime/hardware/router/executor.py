    ...
    def execute_plan(self, plan: dict) -> dict:
        ...
        if not AllocationIntegrityGate.validate_allocation(affinity_mask, max_threads):
            return {
                ...
                "reason": "INVALID_AFFINITY_MASK_AT_EXECUTION"
            }
        ...
        try:
            ...
            if not p.is_running():
                return {
                    "execution_status": "EXECUTION_FAILED",
                    "reason": "TARGET_PROCESS_NOT_RUNNING"
                }
            ...
            return {
                "execution_status": "EXECUTION_FAILED",
                "reason": f"PROCESS_ACCESS_ERROR: {str(e)}"
            }
        ...
        try:
            ...
            return {
                "execution_status": "EXECUTION_FAILED",
                "reason": f"OS_AFFINITY_APPLICATION_ERROR: {str(e)}"
            }
