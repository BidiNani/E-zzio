...
declare module '$env/static/private' {
	...
	export const CUDA_DEVICE_ORDER: string;
	export const CUDA_VISIBLE_DEVICES: string;
	export const DOCKER_DATA_ROOT: string;
	export const DriverData: string;
	export const EDITOR: string;
	export const EZZIO_GPU_POLICY: string;
	export const EZZIO_NO_ADS: string;
	export const EZZIO_NO_SPONSORS: string;
	export const EZZIO_NO_TRACKING: string;
	export const EZZIO_NUM_GPU: string;
	export const FPS_BROWSER_APP_PROFILE_STRING: string;
	export const FPS_BROWSER_USER_PROFILE_STRING: string;
	export const GEMINI_API_KEY: string;
	export const GGML_CUDA: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		DriverData: string;
		EDITOR: string;
		EZZIO_GPU_POLICY: string;
		EZZIO_NO_ADS: string;
		EZZIO_NO_SPONSORS: string;
		EZZIO_NO_TRACKING: string;
		EZZIO_NUM_GPU: string;
