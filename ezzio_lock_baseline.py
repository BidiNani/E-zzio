...
class BaselineLockProtocol:
    ...
    def capture_baseline(self) -> Dict[str, Any]:
        ...
        baseline_data = {
            ...
            "integrity": {
                "genome_sha256": self.get_file_hash(genome_path),
                "framework_sha256": self.get_file_hash(framework_path)
            },
            "hardware_profile": {
