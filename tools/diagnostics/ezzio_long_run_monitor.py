...
class LongRunMonitor:
    ...
    def collect_metrics_tick(self) -> Dict[str, Any]:
        ...
        tick_data = {
            ...
            "storage_growth_mb": {"memory_store_mb": memory_store_size, "snapshots_mb": snapshots_size, "ledgers_mb": ledgers_size},
            "coexistence": {"gaming_detected": gaming_active, "active_profile": profile},
        }
