...
class DailyReportGenerator:
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        report_data = {
            ...
            "memory": {"memory_store_mb": mem_store_mb, "snapshots_mb": snapshots_mb, "ledgers_mb": ledgers_mb},
            "security": {"drift_status": drift, "human_overrides_active": overrides, "incidents_count": 0},
