...
ARCHIVE_PATH = RELEASES_DIR / "E-ZZIO-V9.2-GOLDEN-SOURCE.zip"
MANIFEST_PATH = RELEASES_DIR / "E-ZZIO-V9.2-GOLDEN-MANIFEST.json"
...
INCLUDED_ROOTS = ["core", "runtime", "android", "tools", "assets", "docs", "tests", "dist/android", "routers"]
...
print(f"Creating Golden Source Archive V9.2: {ARCHIVE_PATH} ...")
...
golden_manifest = {
    ...
    "archive_name": "E-ZZIO-V9.2-GOLDEN-SOURCE.zip",
