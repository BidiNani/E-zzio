...
print("[*] E-ZZIO v1.9.3.3 - Reconstruction chirurgicale sans erreur de syntaxe...")
...
print("[+] powershell.py réécrit et syntaxiquement certifié.")
...
print("[+] filesystem.py réécrit et syntaxiquement certifié.")
