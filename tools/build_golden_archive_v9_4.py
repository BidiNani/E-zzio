"""
tools/build_golden_archive_v9_4.py - Generation de l'archive Golden Source et du Manifest V9.4.
"""
import hashlib
import json
import os
...
ARCHIVE_PATH = RELEASES_DIR / "E-ZZIO-V9.4-GOLDEN-SOURCE.zip"
MANIFEST_PATH = RELEASES_DIR / "E-ZZIO-V9.4-GOLDEN-MANIFEST.json"
...
INCLUDED_ROOTS = [
    ...
    "dist/android", "routers", "state/audit/visual/v9.4"
]
...
print(f"Creating Golden Source Archive V9.4: {ARCHIVE_PATH} ...")
...
manifest = {
    "release": "E-ZZIO-V9.4-GOLDEN",
    "version": "9.4.0",
    "timestamp_utc": datetime.now(UTC).isoformat(),
    "golden_baseline": "ezzio-v9.3-golden",
    "branch": "release/v9.4",
    "frozen_core": {
    ...
    "visual_release": {
        ...
        "baseline_dir": "state/audit/visual/v9.4/baseline",
        "final_dir": "state/audit/visual/v9.4/final"
    },
