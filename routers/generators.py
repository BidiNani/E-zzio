...
class XLSXGenerateRequest(BaseModel):
    ...
    title: Optional[str] = Field(None, example="Bilan Opérationnel Q1 2026")
...
class DOCXGenerateRequest(BaseModel):
    ...
    author: Optional[str] = "E-ZZIO Autonomous Core"
...
class PPTXGenerateRequest(BaseModel):
    ...
    subtitle: Optional[str] = Field(None, example="Plateforme d'IA Souveraine")
...
class ImageBannerRequest(BaseModel):
    ...
    subtitle: Optional[str] = Field(None, example="Passerelle Universelle")
    width: int = 1200
    height: int = 630
