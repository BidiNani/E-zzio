...
| `qwen2.5-coder:7b-instruct-q4_K_M` | 4.7 GB | `ACTIVE` | `ollama list` | CODING local primaire (défaut fédération) |
| `qwen3.5:9b` | — | `RETIRED` | absent de `ollama list` | Remplacé par qwen2.5-coder:7b-instruct-q4_K_M |
| `phi4-mini:latest` | 2.5 GB | `ACTIVE` | `ollama list` | Tâches logiques concises & math |
| `nomic-embed-text:latest` | 274 MB | `ABSENT` | absent de `ollama list` | Remplacé par bge-m3 |
